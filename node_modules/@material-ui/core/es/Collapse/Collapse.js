...
const Collapse = React.forwardRef(function Collapse(props, ref) {
  const {
    ...
    timeout = duration.standard
        ...
        other = _objectWithoutPropertiesLoose(props, ["children", "classes", "className", "collapsedHeight", "component", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExiting", "style", "theme", "timeout"]);
  ...
  }), (state, childProps) => React.createElement(Component, _extends({
